           ...
           01 newChar PIC x(1).
           01 testString PIC x(99) VALUE "Yo programming some 
               swagged OUT COBOL".
           01 Result PIC x(99). 
      ...
      * 	  Encrypt.
    	  		          ...
    	  		          IF CharCount < 27 
    	  		          		ADD stringShift, CharCount 
                                   GIVING shiftPos
    	  		          		IF FUNCTION MOD(shiftPos, 26)
                                        IS NOT ZERO 		    				
    	  		          				MOVE FUNCTION MOD(shiftPos, 26)
                                            to shiftPos
    	  		          				MOVE abc(shiftPos:shiftPos)
                                            TO searchChar
    	  		          		ELSE 
